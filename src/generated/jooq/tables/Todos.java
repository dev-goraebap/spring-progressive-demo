...
public class Todos extends TableImpl<TodosRecord> {
     ...
     */
    public final TableField<TodosRecord, String> CONTENT = createField(DSL.name("content"), SQLDataType.VARCHAR(500), this, "");

    /**
     * The column <code>public.todos.created_at</code>.
     */
    public final TableField<TodosRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>public.todos.is_completed</code>.
     */
    public final TableField<TodosRecord, Boolean> IS_COMPLETED = createField(DSL.name("is_completed"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>public.todos.title</code>.
     */
    public final TableField<TodosRecord, String> TITLE = createField(DSL.name("title"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.todos.updated_at</code>.
     */
    public final TableField<TodosRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
