...
public class Posts extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SUMMARY = createField(DSL.name("summary"), SQLDataType.VARCHAR(500).nullable(false), this, "");
     ...
     */
    public final TableField<Record, String> POST_TYPE = createField(DSL.name("post_type"), SQLDataType.VARCHAR(255).nullable(false).defaultValue(DSL.field(DSL.raw("'post'::character varying"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.posts.view_count</code>.
     */
    public final TableField<Record, Integer> VIEW_COUNT = createField(DSL.name("view_count"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
    ...
    private Posts(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> Posts(Table<O> path, ForeignKey<O, Record> childPath, InverseForeignKey<O, Record> parentPath) {
     ...
     */
    public static class PostsPath extends Posts implements Path<Record> {

        private static final long serialVersionUID = 1L;
        public <O extends Record> PostsPath(Table<O> path, ForeignKey<O, Record> childPath, InverseForeignKey<O, Record> parentPath) {
            super(path, childPath, parentPath);
        }
        private PostsPath(Name alias, Table<Record> aliased) {
            super(alias, aliased);
        }
