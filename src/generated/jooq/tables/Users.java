...
public class Users extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> EMAIL = createField(DSL.name("email"), SQLDataType.VARCHAR(254).nullable(false), this, "");
     ...
     */
    public final TableField<Record, String> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(20), this, "");

    /**
     * The column <code>public.users.totp_secret</code>.
     */
    public final TableField<Record, String> TOTP_SECRET = createField(DSL.name("totp_secret"), SQLDataType.VARCHAR(32), this, "");
    ...
    public UniqueKey<Record> getPrimaryKey() {
        return Keys.PK_A3FFB1C0C8416B9FC6F907B7433;
    }

    @Override
    public List<UniqueKey<Record>> getUniqueKeys() {
        return Arrays.asList(Keys.USERS_EMAIL_UNIQUE);
    }
    ...
    public PostsPath posts() {
        if (_posts == null)
            _posts = new PostsPath(this, null, Keys.POSTS__POSTS_USER_ID_USERS_ID_FK.getInverseKey());
    ...
    public SeriesPath series() {
        if (_series == null)
            _series = new SeriesPath(this, null, Keys.SERIES__SERIES_USER_ID_USERS_ID_FK.getInverseKey());
    ...
    public TagsPath tags() {
        if (_tags == null)
            _tags = new TagsPath(this, null, Keys.TAGS__TAGS_USER_ID_USERS_ID_FK.getInverseKey());
