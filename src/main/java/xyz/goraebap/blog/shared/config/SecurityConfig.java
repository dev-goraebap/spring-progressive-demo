...
import xyz.goraebap.blog.shared.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/css/**", "/js/**", "/images/**", "/fonts/**", "/builds/**", "/favicon.ico", "/bgm/**", "/manifest.json", "/sw.js", "/firebase-messaging-sw.js").permitAll()
